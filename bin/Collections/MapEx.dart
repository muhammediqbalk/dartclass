...
void main(){
  ...
  var m1 = <int,String>{1:"one",2:"two"};
  // literal way
  var m2 = <String,dynamic>{"name":"Anu","age":20,"phone":564564585,"cap":7.89};
  print("map = $m2");

//  Map();
 Map m3 = Map(); // create empty
 m3["key1"] = "value1";
 m3["key2"] = "value2";
 m3.addAll(m1);
...
// Map.of();
 ...
 print("map6 = $m6");
// m6["name"] = "BIBIN"; //try to change value of key name - show error since map
// print("map6 = &m6");
 Map m7 = Map.identity();
